...
export default function TransferModal({
  ...
  return (
    <div className="fixed inset-0 z-[1200] bg-black/50 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xl overflow-hidden">
        ...
        <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="mt-1 w-full px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100"
            >
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 overflow-hidden">
            ...
            {error && <div className="px-4 py-3 text-sm text-red-600 dark:text-red-300">{error}</div>}
            <div className="max-h-[260px] overflow-auto">
              {folders.length === 0 && !loading ? (
                ...
                folders.map((f) => (
                  <button
                    key={f.id}
                    onClick={() => setStack((prev) => [...prev, { id: f.id, label: f.name }])}
