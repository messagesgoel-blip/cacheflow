      ...
      const provider1Files: FileMetadata[] = [
        {
          ...
          pathDisplay: 'some-id-from-google',
          size: 1024,
      ...
      const provider2Files: FileMetadata[] = [
        {
          ...
          pathDisplay: '/path/to/document.pdf',
          size: 1024, // Same size
          mimeType: 'application/pdf',
          isFolder: false,
      ...
      const provider2Files: FileMetadata[] = [
        {
          ...
          pathDisplay: '/path/to/report.txt',
